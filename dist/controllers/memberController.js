...
const login = async (req, res) => {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ username: memberData.username, role: memberData.role, postalcode: memberData.postalcode, bloodtype: memberData.bloodtype }, secretKey, { expiresIn: '1h' });
